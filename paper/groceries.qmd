...
- Time is included as a cumulative measure of the number of months since the start of the dataset in January 2017. 
...
@fig-prediction provides the observed and predicted Affordability Index over time and suggests trends for future affordability under the current conditions. 
